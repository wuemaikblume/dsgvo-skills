...
2. **„Werbung" ist weit auszulegen** (BGH I ZR 218/07): jede Form mittelbarer Absatzförderung. Bewertungsbitte (BGH VI ZR 225/17), Cross-Sell-Banner in Bestellbestätigungen, „wir vermissen Sie"-Mails — alles zählt. Rein transaktionale Inhalte (Versandstatus, Rechnung, Sicherheitswarnung) bleiben einwilligungsfrei.
...
### a) Confirm-Mail enthält Werbe-Block (BGH I ZR 164/09)
...
### b) Order-Confirmation hat Cross-Sell-Block (OLG Hamm 4 U 121/13, BGH-Linie)
...
- **Confirm-Mail mit „Übrigens, hier unsere aktuellen Angebote"** — BGH I ZR 164/09: Confirm-Mail darf keine Werbung enthalten. Das Confirm-Klick zählt sonst als unwirksam, der gesamte DOI-Beweis fällt. Fix: Confirm-Mail nur Bestätigungs-Bitte + Datenschutz-Hinweis + Widerruf.
- **Order-Confirmation mit Footer-Banner „Diese Produkte könnten Sie auch interessieren"** — OLG Hamm 4 U 121/13 + BGH-Linie: Cross-Sell-Hinweis macht aus Trans-Mail eine Werbe-Mail; ohne Marketing-Einwilligung abmahnfähig. Fix: Cross-Sell aus Trans-Mail rausnehmen oder Trans-Mail explizit als Marketing klassifizieren.
...
- **Klartext-E-Mail nach Unsubscribe in der DB lassen** — Art. 5 I c + e: nach Widerruf nur Suppression-Hash speichern (Schutzfunktion), Klartext löschen. Fix: SHA-256-Hash der E-Mail in `email_suppression_list`, Klartext entfernen.
...
- BGH VI ZR 225/17 (10.07.2018) — Bewertungs-Bitte ist Werbung
- OLG Hamm 4 U 121/13 — Cross-Sell-Hinweis in Trans-Mail
- BGH I ZR 169/04 — SMS-Werbung; per analoge Auslegung relevant für Plattform-DMs
