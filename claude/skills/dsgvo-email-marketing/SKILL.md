...
| `AI-CONTENT-AND-TRANSPARENCY.md` | AI-personalisierter Newsletter-Content, EU AI Act Art. 50 (02.08.2026), DSGVO Art. 13/22 bei AI-Personalisierung, LLM-API-Datenminimierung, AI-Bilder, interaktive AI-Mails |
...
- **Newsletter mit eingebettetem AI-Chatbot ohne Hinweis** — EU AI Act Art. 50 Abs. 1 wird am 02.08.2026 unmittelbar anwendbar; Sanktionen bis € 7,5 Mio. / 1,5 % weltweiter Konzern-Jahresumsatz nach Art. 99 Abs. 4 lit. c. Fix: klare visuelle Disclosure VOR der ersten Interaktion („Sie schreiben mit einem KI-Assistenten"); Pattern in `AI-CONTENT-AND-TRANSPARENCY.md`.
...
- [EU AI Act Art. 50 (artificialintelligenceact.eu)](https://artificialintelligenceact.eu/article/50/) — Transparenz-Pflichten für AI-Systeme, anwendbar 02.08.2026; Sanktionen Art. 99 Abs. 4 lit. c
- [EU AI Act Verordnung (EU) 2024/1689 (eur-lex)](https://eur-lex.europa.eu/eli/reg/2024/1689/oj) — offizielle Konsolidierung
- [EU Code of Practice on AI-Generated Content](https://digital-strategy.ec.europa.eu/en/policies/code-practice-ai-generated-content) — freiwillig; Final Mai/Juni 2026 erwartet
