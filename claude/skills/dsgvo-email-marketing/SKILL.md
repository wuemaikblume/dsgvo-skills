...
| Sub-File | Wann laden |
|---|---|
| `CONSENT-AND-DOI.md` | DOI-Flow, Confirm-Mail-Inhalt, Re-Subscribe, Lead-Magnet-Kopplung, Kinder-Newsletter (Art. 8 mit verifizierbarer Trägerschafts-Bestätigung) |
| `UWG-7.md` | UWG § 7 (DE), TKG § 174 (AT), UWG Art. 3 I o (CH), Cold-B2B, LinkedIn-DM, **WhatsApp/Messenger-Marketing**, **Drittland-Outbound DACH → US/UK/Asien** |
| `TRACKING-IN-MAIL.md` | Open-Pixel, Click-Redirect, externe Bilder, Personalisierungs-Tracking |
| `UNSUBSCRIBE-AND-RETENTION.md` | One-Click, RFC 8058, Suppression-Hash, Hard-/**Soft-Bounce (DSGVO-Pattern Art. 5 I d/e)**, Aufbewahrung, Art. 21 II |
