...
> Codex CLI lädt diese Datei bei jeder Anfrage. Sie zwingt den Agent, vor jedem Code-Vorschlag DSGVO-Konformität zu prüfen, wenn personenbezogene Daten an Drittland-Dienste fließen. Stand Mai 2026, v1.4 (DPF-Status verifiziert 2026-05-04 gegen offizielle ITA-Excel-Liste). Quelle und Updates: <https://github.com/wuemaikblume/dsgvo-skills>.
